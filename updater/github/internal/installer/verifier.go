...
func (fn verifyFn) VerifySignature(
	checksum []byte,
	signature []byte,
	hash crypto.Hash,
...
func NewRSAVerifier() Verifier {
	return verifyFn(
		func(checksum, signature []byte, hash crypto.Hash, publicKey crypto.PublicKey) error {
...
func NewECDSAVerifier() Verifier {
	return verifyFn(
		func(checksum, signature []byte, _ crypto.Hash, publicKey crypto.PublicKey) error {
